...
const ConfirmWalletDelete = () => {
  ...
  return (
    <div
      className="absolute w-[88%] md:w-[23rem] px-2 left-[50%] translate-x-[-50%] top-[30%] rounded-lg
     bg-white "
    >
      <div className="text-[1.3rem]  px-4 flex items-center justify-between py-3 ">
        ...
        >
          <>
            <X size={19} className="block md:hidden" />{" "}
      ...
      {/* central section*/}
      <div className="p-3 text-[13px] md:text-base">
      ...
      <div className="flex justify-between py-3 px-4">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="border-[1px] border-red-500 py-2 px-3 rounded-2xl hover:bg-gray-100
             font-medium text-red-500 transition-background duration-300 flex items-center text-[12px] md:text-base uppercase"
          >
            <span>Cancel</span>
          </button>
          <button
            onClick={handleDelete}
            className={` bg-red-500 hover:bg-red-600 text-[12px] md:text-base uppercase
              py-2 px-3 rounded-2xl font-medium text-white transition-background duration-300 flex items-center`}
            disabled={loading}
          >
